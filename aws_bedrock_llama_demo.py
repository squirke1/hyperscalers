...
parser.add_argument(
    "--csv",
    type=str,
    default="bedrock_llama_results.csv",
...
model_id = "meta.llama3-70b-instruct-v1:0"  # Llama 3 70B Instruct
...
# Pricing for Llama 3 70B Instruct (as of June 2024, update if needed)
input_token_price = 0.0008  # USD per 1K input tokens
output_token_price = 0.0012  # USD per 1K output tokens
...
for i in range(num_runs):
    ...
    try:
        resp_text = model_response["generation"]
    except Exception:
        resp_text = ""
    ...
    completion_tokens = usage.get("generation_tokens", 0)
